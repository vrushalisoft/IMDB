...
var movieArr = [
    {
      ...
      original_title: "è€ä¹é—¨ä¹‹é’å±±æµ·æ£ ",
    ...
    },
    {
      ...
      original_title: "Miraculous World: Shanghai, la lÃ©gende de Ladydragon",
    ...
    },
    {
      ...
      id: 755812,
      original_language: "fr",
      original_title: "Miraculous World : New York, les hÃ©ros unis",
    ...
    },
    {
      ...
      overview: "World famous movie star Olivia faces a PR disaster when a paparazzi snaps a photo of her with her married lover, Vincent. The hard-working valet Antonio accidentally appears in the same photo and is enlisted to pose as Oliviaâ€™s new boyfriend as a cover-up. This ruse with Olivia thrusts Antonio into the spotlight and unexpected chaos.",
      popularity: 284.735,
    ...
    },
    {
      ...
      original_title: "ãƒ‰ãƒ©ã‚´ãƒ³ãƒœãƒ¼ãƒ«ï¼º ç‡ƒãˆå°½ãã‚!!ç†±æˆ¦ãƒ»çƒˆæˆ¦ãƒ»è¶…æ¿€æˆ¦",
      ...
      title: "Dragon Ball Z: Broly â€“ The Legendary Super Saiyan",
      video: false,
      vote_average: 7.2,
      vote_count: 664
    },
    {
      ...
      overview: "Explore the evolution of Buzz Lightyear from toy to human in the making of Pixarâ€™s Lightyear. Dive into the origin and cultural impact of everyoneâ€™s favorite Space Ranger, the art of designing a new â€œhuman Buzz,â€ and the challenges faced by the Lightyear crew along the way.",
      popularity: 279.857,
    ...
    },
    {
      ...
      overview: "The last year High School excursion is the walk where anything can happen, but the last year High School excursion with the parents, that is the last straw. And since Ãlvaro CastaÃ±o knows that security is better than the police, he decides to travel with his family to watch over his daughter Sarita, however, his mother-in-law, Raquel, is not willing to allow it and also embarks in the plan . On the paradisiacal beaches of San AndrÃ©s, Ãlvaro CastaÃ±o will become Sara's nightmare and the sensation for the excursion, while his sexy mother-in-law of him will be the one to steal the show. El Paseo 6, the last yeat High School excursion, because the luck of the grandmother, the High School girls wish it.",
      popularity: 288.36,
    ...
    },
    {
      ...
      overview: "When a ruptured water main creates an enormous sinkhole right in front of Bob's Burgers, it blocks the entrance indefinitely and ruins the Belchersâ€™ plans for a successful summer. While Bob and Linda struggle to keep the business afloat, the kids try to solve a mystery that could save their family's restaurant. As the dangers mount, these underdogs help each other find hope and fight to get back behind the counter, where they belong.",
      popularity: 244.266,
    ...
    },
    {
      ...
      id: 592350,
      original_language: "ja",
      original_title: "åƒ•ã®ãƒ’ãƒ¼ãƒ­ãƒ¼ã‚¢ã‚«ãƒ‡ãƒŸã‚¢ THE MOVIE ãƒ’ãƒ¼ãƒ­ãƒ¼ã‚ºï¼šãƒ©ã‚¤ã‚¸ãƒ³ã‚°",
...
// var movies = [{
//     adult: movieArr.adult,
//     backdrop_path: movieArr.backdrop_path,
//     genre_ids: movieArr.genre_ids,
//     id: movieArr.id,
//     original_language: movieArr.original_language,
//     original_title: movieArr.original_title,
//     overview: movieArr.overview,
//     popularity: movieArr.popularity,
//     poster_path: movieArr.poster_path,
//     release_date: movieArr.release_date,
//     title:movieArr.title,
//     video: movieArr.video,
//     vote_average:movieArr.vote_average,
//     vote_count: movieArr.vote_count
// }]
      ...
      result += `<div class="col-lg-3 col-md-6 col-xs-12">
                  <div class="card mb-3">
                      <figure class="movieCard">
                          <img src="${imgUrl}${item.poster_path}" alt="img-fluid">
                          <figcaption>
                              <div class="row">
                                  <div class="col-sm-8">
                                      <h5>${item.title}</h5>
